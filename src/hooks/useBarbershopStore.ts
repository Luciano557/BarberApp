...
const initialDiscounts: Discount[] = [
  ...
  { id: '10', label: '10%', value: 10, type: 'percentage', rounding: 'cliente', paymentMethod: 'todos' },
  { id: '20', label: '20%', value: 20, type: 'percentage', rounding: 'cliente', paymentMethod: 'todos' },
  { id: '30', label: '30%', value: 30, type: 'percentage', rounding: 'cliente', paymentMethod: 'todos' },
  { id: '50', label: '50%', value: 50, type: 'percentage', rounding: 'cliente', paymentMethod: 'todos' },
];
