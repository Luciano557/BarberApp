...
export const BookingLanding = ({ onStart, onManage }: Props) => {
  return (
    <div className="space-y-4">
      <Card
        className="cursor-pointer hover:shadow-md transition-[colors,transform] duration-150 active:scale-[0.98] border-primary/30"
        onClick={onStart}
      >
      ...
      <Card
        className="cursor-pointer hover:shadow-md transition-[colors,transform] duration-150 active:scale-[0.98] border-muted-foreground/20"
        onClick={onManage}
      >
        <CardContent className="flex items-center gap-4 p-6">
