    ...
    <div className="space-y-3">
      ...
      >
        <CardContent className="flex items-start gap-3 p-4">
          ...
          <span className="break-words font-medium text-foreground">Cualquiera disponible</span>
        </CardContent>
      </Card>
      ...
      {barberos.map((b) => (
        ...
        >
          <CardContent className="flex items-start gap-3 p-4">
            ...
            <span className="break-words font-medium text-foreground">{b.nombre} {b.apellido}</span>
          </CardContent>
        </Card>
      ))}
    </div>
